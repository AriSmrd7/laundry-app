                  ...
                  <div class="card-body">
                    <h4 class="text-primary">Ubah Data Pelanggan</h4>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="nama" value="{{$pelanggan->nama}}" required>
                          </div>
                          <div class="form-group">
                            <label for="exampleInputEmail2">Nomor Hp</label>
                            <input type="text" class="form-control" id="exampleInputEmail2" name="telepon" maxlength="13" value="{{$pelanggan->telepon}}" required>
                            </select>
                          </div>
                          <div class="form-group">
