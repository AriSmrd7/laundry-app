                    ...
                    <h4 class="text-primary">Detail Member</h4>
                      <div class="row">
                        ...
                        <div clas="col-md-2 mt-2 mb-2">
                            <a href="{{ route('members-kasir.delmember',$rowInfo->id) }}" onclick="return confirm('Yakin akan menghapus seluruh data member ini dari database?')" class="btn btn-md btn-outline-danger">
                              HAPUS MEMBER
                            </a>
                        </div>
                      </div>
                        ...
                        <div class="alert alert-success">
                            <p>
                              ...
                              {{ $message }}<a href="{{route('members-kasir.index')}}"><strong>Klik disini</strong></a></p>
                        </div>
                        @endif
                        ...
                        <table class="table table-bordered mt-3 detailFormat">
                          ...
                          @foreach($membersDetail as $detail)
                            ...
                            <tr>
                              ...
                              <td><a onclick="return confirm('Yakin akan menghapus paket dari member ini?')" href="{{ route('members-kasir.delete',$detail->id) }}" class="btn btn-danger btn-xs">X</a></td>
                            </tr>
                          @endforeach
                          @endif
                          </tbody>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <h4 class="text-primary">Tambah Paket Baru</h4>
                      <form action="{{route('members-kasir.update',$rowsId->id)}}" method="POST">
                        @csrf
                        <div class="row">
                          <div class="col-md-4">
                          ...
                          <div class="col-md-2">
                            <div class="form-group row">
                              <div class="col-sm-12">
                                ...
                                <input type="text" name="jumlah" maxlength="5" class="form-control" id="jumlah" placeholder="0" required />
                              </div>
                            </div>
                          </div>
                          <div class="col-md-2">
